...
int main (int argc, char *argv[])
{
  ...
  cmd.AddValue ("queueDiscType", "Set Queue disc type to RED or MRED", queueDiscType);
  ...
  if ((queueDiscType != "RED") && (queueDiscType != "MRED"))
    {
      std::cout << "Invalid queue disc type: Use --queueDiscType=RED or --queueDiscType=MRED" << std::endl;
      exit (1);
    }
